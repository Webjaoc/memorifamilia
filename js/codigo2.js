...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let timerDisplay = document.querySelector('#timer'); // Elemento para mostrar el temporizador
    let messageDisplay = document.querySelector('#message'); // Elemento para mostrar mensajes
    ...
    function checkForMatch() {
        ...
        if (cardsWon.length === cardArray.length / 2) {
            messageDisplay.textContent = '¡Felicidades! ¡Has encontrado todos los pares!'; // Mostrar mensaje de felicitaciones
    ...
    function resetGame() {
        ...
        timeLeft = 45; // Reiniciar el tiempo
        timerDisplay.textContent = `Time: ${timeLeft}s`; // Mostrar el tiempo reiniciado
        messageDisplay.textContent = ''; // Limpiar el mensaje de felicitaciones
    ...
    function startTimer() {
        timer = setInterval(() => {
            ...
            if (timeLeft <= 0) {
                clearInterval(timer);
                messageDisplay.textContent = '¡Game Over! El tiempo se ha agotado.';
